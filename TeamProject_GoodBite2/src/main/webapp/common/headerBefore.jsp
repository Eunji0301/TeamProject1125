	...
	<header id="header" >
      ...
      <div id="sidebar"  class="sidebar">
        ...
        <div class="sidebarLoginLine d-flex align-items-center justify-content-center mb-3">
  			<img src="../resources/headerImage/loginBeforeProfile.png" alt="" width="50" height="50" class="rounded-circle me-2">
  			<button>로그인</button>
		</div>
        ...
        <ul class="nav flex-column p-4">
      	...
      	<div class="sidebar-footer justify-content-around py-4">
