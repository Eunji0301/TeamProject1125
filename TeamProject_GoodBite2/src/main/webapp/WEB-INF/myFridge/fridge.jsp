	...
	<div class="container">
			...
			<div class="fridge" id="fridgeItems">
				...
				<div class="d-flex align-items-center">
					...
					<ul class="ingredient-list d-flex flex-wrap">
						<li class="ingredient-item">우유 (1L)</li>
						<li class="ingredient-item">달걀 (12개)</li>
						<li class="ingredient-item">베이컨 (3개)</li>
						<li class="ingredient-item">치즈 (200g)</li>
					</ul>
				</div>
		...
		<div class="fridge-container mt-4">
			...
			<div class="freezer" id="freezerItems">
				<ul class="ingredient-list d-flex flex-wrap">
					<li class="ingredient-item">닭고기 (1kg)</li>
				</ul>
		...
		<div class="fridge-container mt-4">
			...
			<div class="recipes" id="recipeItems">
				...
				<div class="recipe-item">
					<img src="../resources/img/mealReportSY/scramble.jpg" alt="스크램블"
						class="recipe-img">
