  ...
  <div class="row mb-4">
    <div class="row justify-content-center mb-4">
      <div class="col-md-2 text-center">
        <img src="/resourcesSO/image/cat.jpg" alt="사진 1" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
        <p>1.홍길동</p>
      </div>
      <div class="col-md-2 text-center">
        <img src="/resourcesSO/image/cat.jpg" alt="사진 2" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
        <p>2.홍길동</p>
      </div>
      <div class="col-md-2 text-center">
        <img src="/resourcesSO/image/cat.jpg" alt="사진 3" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
        <p>3.홍길동</p>
      </div>
      <div class="col-md-2 text-center">
        <img src="/resourcesSO/image/cat.jpg" alt="사진 4" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
        <p>4.홍길동</p>
      </div>
      <div class="col-md-2 text-center">
        <img src="/resourcesSO/image/cat.jpg" alt="사진 5" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
        <p>5.홍길동</p>
      </div>
    </div>
  </div>
    ...
    <div class="d-flex flex-column" style="width: 70%;">
      ...
      <div class="challenge-box mb-4">
        ...
        <div id="week-1" class="photo-wrapper">
          <div>
            <img src="/resourcesSO/image/cat.jpg" alt="사진 1" style="width: 100px; height: 100px;">
        ...
        <div id="week-2" class="photo-wrapper" style="display: none;">
          <div>
            <img src="/resourcesSO/image/cat.jpg" alt="사진 2" style="width: 100px; height: 100px;">
        ...
        <div id="week-3" class="photo-wrapper" style="display: none;">
          <div>
            <img src="/resourcesSO/image/cat.jpg" alt="사진 3" style="width: 100px; height: 100px;">
      ...
      <div class="challenge-box">
        ...
        <div id="week-4" class="photo-wrapper">
          <div>
            <img src="/resourcesSO/image/cat.jpg" alt="사진 4" style="width: 100px; height: 100px;">
            <p>1주: 홍길동님이 ㅇㅇㅇ 챌린지를 완료했습니다!</p>
          </div>
        </div>
        ...
        <div id="week-5" class="photo-wrapper" style="display: none;">
          <div>
            <img src="/resourcesSO/image/cat.jpg" alt="사진 5" style="width: 100px; height: 100px;">
            <p>2주: 홍길동님이 ㅇㅇㅇ 챌린지를 완료했습니다!</p>
          </div>
        </div>
        ...
        <div id="week-6" class="photo-wrapper" style="display: none;">
          <div>
            <img src="/resourcesSO/image/cat.jpg" alt="사진 6" style="width: 100px; height: 100px;">
            <p>3주: 박지민님이 ㅇㅇㅇ 챌린지를 완료했습니다!</p>
          </div>
        </div>
